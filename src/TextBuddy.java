...
public class TextBuddy {
    ...
    private static final String WARNING_FILE_EXISTS = "Warning: The file already exists and it may not have been created by TextBuddy."
    ...
    private static String readAndSkipLine(int lineNumberToDelete,
            StringBuilder newContentBuilder) throws IOException {
        setUpReader();
        int lineNumber = 1;
        String lineString = fileReader.readLine();
        while (lineString != null) {
    ...
    private static String processContent(String lineContent) throws IOException {
        ...
        while (lineContent != null) {
            ...
            // Add new line before all lines except first one
            if (lineNumber > 1) {
                contentToDisplayBuilder.append(System
                        .getProperty("line.separator"));
            }
